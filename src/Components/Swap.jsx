...
function Swap() {
  ...
  return (
    <div className="w-11/12 max-w-[486px] bg-[#F8F8F9] mx-auto p-6 mt-16 relative">
      ...
      <div className="p-4 bg-white rounded-md mt-[-25px]">
        <div className="flex items-center justify-between">
          <h3 className="text-[#636A7E] font-medium">To</h3>
          {/* <p className='font-semibold text-sm mr-4'>Use Max</p> */}
        </div>
        <div className="flex">
          <div className="flex-1">
      ...
      <button className="capitalize w-full h-[52px] font-[16px] text-[#DDDFE4] bg-[#F4F4F6] mt-3">
        Enter A Amount
      </button>
    </div>
  );
